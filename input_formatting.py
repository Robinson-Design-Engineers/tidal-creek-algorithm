...
def input_formatting(filename):
    ...
    # i.e., filename = 'INPUTS/blahblah_elev.txt' or 'INPUTS/blahblah_slope.txt'
    filename = filename
    # i.e., h5py.File('INPUTS/blahblah_elev_metadata.h5')
    filename_out_meta = 'INPUTS/'+filename[7:-4]+'_metadata.h5' # strips string to just get filename
    # i.e., h5py.File('INPUTS/blahblah_elev.h5')
    filename_out = 'INPUTS/'+filename[7:-4]+'.h5' # strips string to just get filename
